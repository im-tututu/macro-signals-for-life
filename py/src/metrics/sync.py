...
DIRECT_SOURCE_SPECS: tuple[SourceMetricSpec, ...] = (
    ...
    SourceMetricSpec("ust_2y", "raw_overseas_macro", "1 = 1", "ust_2y", 0.01),
    SourceMetricSpec("ust_10y", "raw_overseas_macro", "1 = 1", "ust_10y", 0.01),
    SourceMetricSpec("usd_broad", "raw_overseas_macro", "1 = 1", "usd_broad"),
    SourceMetricSpec("usd_cny", "raw_overseas_macro", "1 = 1", "usd_cny"),
    SourceMetricSpec("gold", "raw_overseas_macro", "1 = 1", "gold"),
    SourceMetricSpec("wti", "raw_overseas_macro", "1 = 1", "wti"),
    SourceMetricSpec("brent", "raw_overseas_macro", "1 = 1", "brent"),
    SourceMetricSpec("copper", "raw_overseas_macro", "1 = 1", "copper"),
    SourceMetricSpec("vix", "raw_overseas_macro", "1 = 1", "vix"),
    SourceMetricSpec("spx", "raw_overseas_macro", "1 = 1", "spx"),
    SourceMetricSpec("nasdaq_100", "raw_overseas_macro", "1 = 1", "nasdaq_100"),
)
