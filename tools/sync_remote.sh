...
#   REMOTE_HOST=tututu.fun
#   REMOTE_PORT=50022
#   REMOTE_USER=ubuntu
#   REMOTE_APP_DIR=~/apps/macro-signals-for-life
#   SSH_KEY_PATH=~/.ssh/id_ed25519
#   LOCAL_ENV_PATH=.env
#   LOCAL_DB_PATH=py/data/db.sqlite

REMOTE_HOST="${REMOTE_HOST:-tututu.fun}"
REMOTE_PORT="${REMOTE_PORT:-50022}"
REMOTE_USER="${REMOTE_USER:-ubuntu}"
REMOTE_APP_DIR="${REMOTE_APP_DIR:-~/apps/macro-signals-for-life}"
